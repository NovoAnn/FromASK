...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { KEY[2] }]; #IO_L9P_T1_DQS_14 Sch=btnc
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { KEY[3] }]; #IO_L10N_T1_D15_14 Sch=btnr
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { KEY[4] }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd

#Pmod Header JA (renamed to GPIO)
...
set_input_delay -clock "clk_virt" -min -add_delay 0.000 [get_ports {KEY[*]}]
set_input_delay -clock "clk_virt" -max -add_delay 10.000 [get_ports {KEY[*]}]
